---
title: Integrate authorized review adapters
status: planning
created: 2026-07-25
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/07-25-integrate-authorized-review-adapters`:
