---
title: Make the durable lane honor the repository's managed route policy
status: done
created: 2026-08-22
branch: feat/durable-lane-route-policy
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-22-durable-lane-route-mode`:
