---
title: Align local full check with CI
status: done
created: 2026-07-25
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/07-25-align-local-full-check-with-ci`:
