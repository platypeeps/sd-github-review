---
title: Local review gate cannot converge under advisory-mode prism findings
status: done
created: 2026-08-09
branch: task/review-gate-advisory-convergence
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-09-review-gate-advisory-convergence`:
