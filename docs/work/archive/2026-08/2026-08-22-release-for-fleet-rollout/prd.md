---
title: Survey main since v0.3.0 and cut the release the fleet rollout needs
status: done
created: 2026-08-22
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-22-release-for-fleet-rollout`:

- pilot-v0.5.0.md
- research/range-survey.md
