---
title: Reject symlinked installer targets
status: done
created: 2026-07-25
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/07-25-reject-symlinked-installer-targets`:
