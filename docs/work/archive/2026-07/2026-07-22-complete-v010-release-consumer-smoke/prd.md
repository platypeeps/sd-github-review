---
title: Complete v0.1.0 release and consumer smoke
status: done
created: 2026-07-22
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-22-complete-v010-release-consumer-smoke`:

- research/candidate-evidence.md
- research/pilot-evidence.md
- research/release-evidence.md
