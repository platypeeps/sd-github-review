---
title: Define public Trellis metadata policy
status: done
created: 2026-07-22
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-22-define-public-trellis-metadata-policy`:

- research/metadata-inventory.md
