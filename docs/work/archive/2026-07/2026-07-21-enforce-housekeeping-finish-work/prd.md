---
title: Enforce finish-work before housekeeping merge
status: done
created: 2026-07-21
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-21-enforce-housekeeping-finish-work`:
