---
title: Implement durable routed-review receipts
status: done
created: 2026-07-23
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-23-implement-durable-routed-review-receipts`:
