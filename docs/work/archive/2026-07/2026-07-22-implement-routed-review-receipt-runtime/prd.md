---
title: Decompose routed-review receipt runtime delivery
status: done
created: 2026-07-22
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-22-implement-routed-review-receipt-runtime`:

- research/scope-split.md
