---
title: Validate external reviewer adapters
status: done
created: 2026-07-22
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-07/07-22-validate-external-reviewer-adapters`:

- research/implementation-sources.md
- research/readiness-2026-07-24.md
