...
| P2 | The Trellis bootstrap task and specs assumed a generic full-stack application, so future agents could receive irrelevant database/frontend guidance. | `.trellis/tasks/archive/2026-07/00-bootstrap-guidelines/prd.md:1` | Resolved by replacing the generic guidance and archiving the completed bootstrap task. |
